      ...
      <div className="flex-1 flex flex-col justify-end px-6 pb-12 z-10 sm:justify-center max-w-md mx-auto w-full pt-16">
        ...
        <div className="mb-10">
          <h1 className="text-4xl font-light text-cream tracking-tight mb-3">
             Start <br />
             <span className="font-medium bg-gradient-to-r from-orange-400 to-orange-600 bg-clip-text text-transparent">Designing.</span>
          </h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="relative">
            <div className="absolute inset-y-0 text-slate-500 left-4 flex items-center text-xs font-semibold tracking-wider pointer-events-none uppercase">NM</div>
            <input 
              type="text" 
              required
          ...
          <div className="relative">
            <div className="absolute inset-y-0 text-slate-500 left-4 flex items-center text-xs font-semibold tracking-wider pointer-events-none uppercase">ID</div>
            <input 
              type="email" 
              required
              className="w-full bg-[#0d121c]/80 backdrop-blur-xl border border-slate-800/80 text-cream rounded-[20px] pl-14 pr-5 py-4 focus:outline-none focus:border-orange-500/50 focus:bg-[#121926] transition-all font-light text-[16px] placeholder-slate-600"
          ...
          <div className="relative">
            <div className="absolute inset-y-0 text-slate-500 left-4 flex items-center text-xs font-semibold tracking-wider pointer-events-none uppercase">PW</div>
            <input 
              type="password" 
              required
              className="w-full bg-[#0d121c]/80 backdrop-blur-xl border border-slate-800/80 text-cream rounded-[20px] pl-14 pr-5 py-4 focus:outline-none focus:border-orange-500/50 focus:bg-[#121926] transition-all font-light text-[16px] placeholder-slate-600"
          ...
          >
            <span className="text-[16px]">{loading ? 'Creating...' : 'Sign Up'}</span>
            {loading ? <Loader2 size={18} className="animate-spin text-slate-600" /> : <ArrowRight size={18} className="text-slate-600" />}
          </button>
        </form>

        <p className="text-center text-slate-500 text-[15px] mt-8 font-light">
          Already have an account? <Link to="/login" className="text-cream font-medium hover:text-orange-400 transition-colors">Sign in</Link>
        </p>
      </div>
    </div>
  );
